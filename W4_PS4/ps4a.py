...
WORDLIST_FILENAME = "C:\Users\Denys\Canopy\studing\edx_MITx_6.00.1x\W4_PS4\words.txt"
...
def getWordScore(word, n):
    ...
    if len(word) == n:
        return sum(score) * len(word) + 50
    elif word == '.':
        return 0
    else:
        return sum(score) * len(word)
...
def isValidWord(word, hand, wordList):
    ...
    return letterInWord and wordInWordList
    # TO DO ... <-- Remove this comment when you code this function
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while word != "." and sum(hand.values()) != 0:
        # Display the hand
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                #print word != "." and sum(hand.values()) != 0
